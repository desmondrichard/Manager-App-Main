            ...
            <div className="pg-footer">
                <footer className="footer">
                    ...
                    <div className="footer-content">
                        <div className="footer-content-column">
                            <div className="footer-logo">
                                <span className="footer-logo-link">
                                    ...
                                    <h1>
                                        <Logo src={require('./../../assets/m_logo.png')} style={{ width: '100px', height: '80px' }} fluid></Logo>
                                    </h1>
                                </span>
                            </div>
                            <div className="footer-menu">
                                ...
                                <ul id="menu-get-started" className="footer-menu-list">
                                    <li className="menu-item menu-item-type-post_type menu-item-object-product linkHover">
                                        Home
                                    </li>
                                    <li className="menu-item menu-item-type-post_type menu-item-object-product linkHover">
                                        Address
                        ...
                        <div className="footer-content-column">
                            <div className="footer-menu">
                                ...
                                <ul id="menu-company" className="footer-menu-list">
                                    <li className="menu-item menu-item-type-post_type menu-item-object-page linkHover">
                                        Contact
                                    </li>
                                    <li className="menu-item menu-item-type-taxonomy menu-item-object-category linkHover">
                                        News
                                    </li>
                                    <li className="menu-item menu-item-type-post_type menu-item-object-page linkHover">
                                        Careers
                            ...
                            <div className="footer-menu">
                                ...
                                <ul id="menu-legal" className="footer-menu-list">
                                    <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-privacy-policy menu-item-170434 linkHover">
                                        Privacy Notice
                                    </li>
                                    <li className="menu-item menu-item-type-post_type menu-item-object-page linkHover">
                                        Terms of Use
                        ...
                        <div className="footer-content-column">
                            <div className="footer-menu">
                                ...
                                <ul id="menu-quick-links" className="footer-menu-list">
                                    <li className="menu-item menu-item-type-custom menu-item-object-custom linkHover">
                                        Support Center
                                    </li>
                                    <li className="menu-item menu-item-type-custom menu-item-object-custom linkHover">
                                        Service Status
                                    ...
                                    <li className="menu-item menu-item-type-post_type_archive menu-item-object-customer linkHover">
                                        Customers</li>
                                    <li className="menu-item menu-item-type-post_type menu-item-object-page linkHover">
                                        Reviews
                                    </li>
                        ...
                        {/* </svg> */}
                            <span className="footer-social-link linkedin">
                            ...
                            <span className="footer-social-link twitter">
                            ...
                            <span className="footer-social-link youtube">
                            ...
                            <span className="footer-social-link github">
                    ...
                    <div className="footer-copyright">
                        <div className="footer-copyright-wrapper">
                            <p className="footer-copyright-text">
                                <span className="footer-copyright-link"> ©{year}| Manager App | All rights reserved. </span>
                            </p>
                        </div>
                    </div>
                </footer>
