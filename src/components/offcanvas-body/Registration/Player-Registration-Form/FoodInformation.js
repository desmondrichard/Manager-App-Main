...
function StaffFoodInformation({ activationKey, onActivationKeyChild, onPreviousActivationKey, showPutData, showSaveBtn, showClearBtn, handlePrevClick, previousClk, showSkipBtn }) {
    ...
    const formik = useFormik({
        ...
        onSubmit: values => {
            ...
            axios.post('http://192.168.1.135/Manager-App-API/FoodInformationModel', newValues)
                .then(response => {
    ...
    function handleUpdate() {
        ...
        axios.put(`http://192.168.1.135/Manager-App-API/FoodInformationModel/${showPutData.alldataplayerId}`, formik.values, {
            headers: {
                    ...
                    <Form style={{ paddingRight: '60px' }} onSubmit={formik.handleSubmit}>
                        ...
                        <Row>
                            <Col lg={12} className='my-4 col'>
                                ...
                                {!showSaveBtn && <Button variant="info" className='mx-1 updatePi' style={{ whiteSpace: 'nowrap', width: '130px', marginTop: '-8px' }} onClick={handleUpdate}>Update</Button>}
