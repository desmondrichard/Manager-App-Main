...
function Travelinformation({ activationKey, onActivationKeyChild, onPreviousActivationKey, showPutData, showSaveBtn, showClearBtn, handlePrevClick, previousClk, showSkipBtn }) {
    ...
    const formik = useFormik({
        ...
        onSubmit: values => {
            ...
            axios.post('http://192.168.1.134/MA-APP/TravelInformationModel', values)
                .then(response => {
    ...
    function handleUpdate() {
        ...
        axios.put(`http://192.168.1.134/MA-APP/TravelInformationModel/${showPutData.alldataplayerId}`, formik.values, {
            headers: {
