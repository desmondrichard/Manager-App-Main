...
function ProficiencyForm({ activationKey, onActivationKeyChild, onPreviousActivationKey, showPutData, showSaveBtn, showClearBtn, handlePrevClick, previousClk, showSkipBtn }) {
    ...
    const formik = useFormik({
        ...
        validate,
        onSubmit: values => {
            axios.post('http://192.168.1.134/MA-APP/playerSpecializationModel', values)
                .then(response => {
    ...
    function handleUpdate() {
        axios.put(`http://192.168.1.134/MA-APP/SpecializationModel/${showPutData.alldataplayerId}`, formik.values, {
            headers: {
                    ...
                    <Form onSubmit={formik.handleSubmit}>
                        <Row>
                            ...
                            <Col xs={12} lg={12} className='my-4 col'>
                                ...
                                {!showSaveBtn && <Button variant="info" className='mx-1 updateP' style={{ whiteSpace: 'nowrap', width: '130px', marginTop: '7px' }} onClick={handleUpdate}>Update</Button>}
