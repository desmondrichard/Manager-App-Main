...
function StaffEmergencyContact({ activationKey, onActivationKeyChild, onPreviousActivationKey, showPutData, showSaveBtn, showClearBtn, handlePrevClick, previousClk, showSkipBtn }) {
    ...
    const formik = useFormik({
        ...
        onSubmit: (values, { setSubmitting }) => {
            ...
            axios.post('http://192.168.1.134/MA-APP/StaffEmergencycontactmodel', newValues)
                .then(response => {
    ...
    function handleUpdate() {
        ...
        axios.put(`http://192.168.1.134/MA-APP/StaffEmergencycontactmodel/${showPutData.alldataStaffId}`, newValues, {
            headers: {
